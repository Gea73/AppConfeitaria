...
export default function CreateItem() {
    ...
    async function HandleCreateItem() {
        try {
            ...
            const result = await itemService.createItem(name, description, Number(price), imageUrl)
            console.log(result)
        } catch (e: any) {
                ...
                <SafeAreaView style={{ flex: 1 }}>
                    ...
                    >
                        ...
                        <View style={stylesheet.itemPreviewContainer}>
                            <ItemCard uid="" name={name} description={description} price={Number(price)} imageUrl={imageUrl} onEdit={() => { }}></ItemCard>
                        </View>
                        ...
                        <View style={stylesheet.formContainer}>
                            ...
                            <View style={stylesheet.buttonContainer}>
                                <Button onPress={() => HandleCreateItem()} text="Criar"></Button>
                            </View>
