            ...
            <SafeAreaProvider style={{ backgroundColor: "white" }}>
                <SafeAreaView style={{ flex: 1 }}>
                    ...
                    <View style={stylesheet.itemsContainer}>
                        <FlatList data={order?.getItems()} renderItem={({ item }) => (
                    ...
                    <View style={stylesheet.orderContainer}>
                        ...
                        <Text style={stylesheet.orderText}>R$ {order?.getItems().reduce((sum, i) => sum + i.quantity * i.price, 0).toFixed(2).replace(".", ",")}</Text>
