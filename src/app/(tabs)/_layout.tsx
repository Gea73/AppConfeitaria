...
export default function TabLayout() {
    return (
        <Tabs screenOptions={{
            headerShown: false, tabBarStyle: { height:110,
                backgroundColor: colors.primary, borderTopColor: colors.secondary
            }, tabBarActiveTintColor: colors.active, tabBarInactiveTintColor: colors.secondary
        }}>
